...
@Component({
  ...
  template: `
    <div>
      <button class="start-button" *ngIf="!isRecording && !blobUrl" (click)="startRecording()" ng-disabled="started">Start Recording</button>
      <button class="stop-button" *ngIf="isRecording && !blobUrl" (click)="stopRecording()" ng-disabled="stopped">Stop Recording</button>
